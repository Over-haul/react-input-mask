...
var _excluded$1 = ["alwaysShowMask", "children", "mask", "maskPlaceholder", "beforeMaskedStateChange", "customInputRef"];
var InputMask = /*#__PURE__*/React.forwardRef(function InputMask(props, forwardedRef) {
  var alwaysShowMask = props.alwaysShowMask,
    ...
    customInputRef = props.customInputRef,
  ...
  var inputProps = _extends({}, restProps, {
    ...
    ref: function ref(_ref) {
      inputRef.current = customInputRef == null ? void 0 : customInputRef.current;
...
InputMask.propTypes = {
  ...
  customInputRef: PropTypes.oneOfType([PropTypes.func, PropTypes.shape({
